...
\begin{center}
\textit{[Obrázek: Stránka zobrazuje tři historické černobílé pohlednice budovy Sokolovny v~Porubě. Každá pohlednice ukazuje budovu z~různých úhlů a~s~různými popisky.]}
\end{center}
...
% TODO: Replace with actual image
\textit{[Obrázek: Skupinová fotografie členů Sokola, 1926 v~Porubě]}
...
% TODO: Replace with actual image
\textit{[Obrázek 1: Tělocvična roku 1933. V~pozadí vlevo je pianino jednoty. Před jevištěm hrazda, připravená ke cvičení, v~popředí je vidět kruhy.]}

% TODO: Replace with actual image
\textit{[Obrázek 2: Hřiště pro házenou u~sokolovny. Vlevo je viděti stojan pro kruhy, u~něho sloup s~lampou pro osvětlení hřiště. Uprostřed jsou sloupky se sítí na odbíjenou.]}

% TODO: Replace with actual image
\textit{[Obrázek 3: Skupina bratrů pracujících na hřišti pro odbíjenou. V~pozadí zahrada, vpravo sokolovna.]}

% TODO: Replace with actual image
\textit{[Obrázek 4: Sokolské kluziště na rybníku statkáře Wilczka.]}

% TODO: Replace with actual image
\textit{[Obrázek 5: Závěrečná skupina veřejného cvičení. Muži a~ženy v~krojích vpochodovali na cvičiště za zpěvu sokolské pochodové Tyršovy hymny \enquote{V~nový život}. Na můstku stojící náčelník Krejčí Ant.\ vztyčil za zvuku národních hymen státní vlajku.]}
...
\noindent\textit{Píši poprvé do kroniky jednoty. Možná, že jsem věc neudělal úplně správně, ale první prací se školíme nejvíce.}
